...
import { Copy, Check, Bold, Italic, Heading, List, Code, FileCode } from "lucide-react";
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <span className="text-xs font-mono text-slate-500 bg-[#090D16] border border-slate-800 px-3 py-2 rounded-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div
          ...
          className="w-full h-[260px] bg-[#090D16] border border-slate-800 rounded-lg p-4 text-xs text-slate-300 leading-relaxed overflow-y-auto"
        />
      </div>
    </div>
  );
