...
export default function QrGenerator() {
  ...
  // Google Charts API tabanlı pratik ve güvenli istemci tarafı QR görsel oluşturucu
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-400 mt-1">
          URL veya metinleriniz için yüksek kaliteli QR kodlar oluşturun ve indirin.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-[#090D16] border border-slate-800 rounded-lg p-5 space-y-4 text-xs">
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full bg-[#0D121F] border border-slate-800 rounded-lg p-3 text-xs font-mono text-slate-200 focus:outline-none focus:border-slate-700 resize-none"
            />
          </div>
        ...
        <div className="bg-[#090D16] border border-slate-800 rounded-lg p-6 flex flex-col items-center justify-center space-y-4">
          <div className="bg-white p-3 rounded-xl shadow-inner border border-slate-800 flex items-center justify-center">
            {text ? (
              <img src={qrImageUrl} alt="QR Code" width={size} height={size} className="rounded" />
            ) : (
          ...
          {text && (
            <a
              ...
              className="bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-semibold text-xs py-2 px-4 rounded-lg transition flex items-center gap-1.5"
            >
