...
import { Copy, Check, Globe, Share2, Search } from "lucide-react";
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">
            SEO ve sosyal medya paylaşımları için gelişmiş HTML meta etiketleri oluşturun.
          </p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-[#090D16] border border-slate-800 rounded-lg p-5 space-y-4 text-xs">
          <div className="space-y-1">
            ...
            />
            <span className="text-[10px] text-slate-500">{siteTitle.length} / 60 karakter önerilen</span>
          </div>
          ...
          <div className="space-y-1">
            ...
            />
            <span className="text-[10px] text-slate-500">{siteDescription.length} / 160 karakter önerilen</span>
          </div>
