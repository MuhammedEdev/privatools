...
export default function AboutPage() {
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-[#030712] dark:bg-slate-50 text-slate-100 dark:text-slate-900 flex flex-col justify-between py-12 px-4 sm:px-6 lg:px-8 transition-colors duration-300">
      <div className="max-w-4xl mx-auto space-y-12 w-full">
        
        {/* Başlık */}
        <div className="text-center space-y-3">
          <h1 className="text-3xl sm:text-5xl font-extrabold text-white dark:text-slate-900 tracking-tight">
            Geliştiriciler İçin, <br />
            <span className="bg-gradient-to-r from-emerald-400 to-teal-500 bg-clip-text text-transparent">
              Gizlilik Odaklı Altyapı
            </span>
          </h1>
          <p className="text-slate-400 dark:text-slate-600 text-sm sm:text-base max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-[#0D121F] dark:bg-white border border-slate-800/80 dark:border-slate-200 rounded-2xl p-6 space-y-3 shadow-sm">
            <div className="w-10 h-10 rounded-xl bg-emerald-500/10 flex items-center justify-center text-emerald-400">
              <Lock className="w-5 h-5" />
            </div>
            <h3 className="text-base font-semibold text-white dark:text-slate-900">%100 Client-Side</h3>
          ...
          <div className="bg-[#0D121F] dark:bg-white border border-slate-800/80 dark:border-slate-200 rounded-2xl p-6 space-y-3 shadow-sm">
            ...
            <h3 className="text-base font-semibold text-white dark:text-slate-900">Işık Hızında Performans</h3>
            <p className="text-xs text-slate-400 dark:text-slate-600 leading-relaxed">
          ...
          <div className="bg-[#0D121F] dark:bg-white border border-slate-800/80 dark:border-slate-200 rounded-2xl p-6 space-y-3 shadow-sm">
            ...
            <h3 className="text-base font-semibold text-white dark:text-slate-900">25+ Pro Araç</h3>
            <p className="text-xs text-slate-400 dark:text-slate-600 leading-relaxed">
        ...
        <div className="bg-[#0D121F] dark:bg-white border border-slate-800/80 dark:border-slate-200 rounded-2xl p-8 space-y-6 shadow-sm">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-emerald-500/10 flex items-center justify-center text-emerald-400">
              <ShieldCheck className="w-5 h-5" />
            </div>
            <div>
              <h3 className="text-lg font-bold text-white dark:text-slate-900">Neden PrivaTools?</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
            <div className="bg-[#030712]/60 dark:bg-slate-100 border border-slate-800/60 dark:border-slate-200 p-4 rounded-xl space-y-2">
        ...
        {/* Alt CTA */}
        <div className="bg-[#0D121F] dark:bg-white border border-slate-800/80 dark:border-slate-200 rounded-2xl p-8 text-center space-y-4 shadow-sm">
          <h3 className="text-xl font-bold text-white dark:text-slate-900">Stüdyoyu Keşfetmeye Başlayın</h3>
